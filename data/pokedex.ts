export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	charizard: {
		...
		abilities: {0: "Blaze", 1: "Solar Power", H: "Dragon's Maw"},
		heightm: 1.7,
		weightkg: 90.5,
		color: "Red",
		prevo: "Charmeleon",
	...
	sora: {
		...
		abilities: {0: "Dazzling", 1: "Serene Grace", H: "Misty Surge", S: "Seiso"},
		heightm: 1.6,
		weightkg: 55.5,
		color: "Brown",
	...
	soramega: {
		...
		types: ["Fairy"],
		gender: "F",
		baseStats: {hp: 80, atk: 85, def: 85, spa: 145, spd: 200, spe: 105},
	...
	miko: {
		...
		types: ["Fairy", "Grass"],
		gender: "F",
		baseStats: {hp: 80, atk: 110, def: 80, spa: 125, spd: 135, spe: 70},
		abilities: {0: "Unaware", 1: "Serene Grace", H: "Flare Boost", S: "Elite"},
		heightm: 1.52,
		weightkg: 55.5,
		color: "Pink",
		eggGroups: ["Human-Like", "Fairy"],
	...
	mikoelite: {
		...
		abilities: {0: "Flame Body", 1: "Flash Fire", H: "Drought", S: "Elite"},
		heightm: 1.52,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
	...
	suisei: {
		...
		types: ["Ice", "Rock"],
		gender: "F",
		baseStats: {hp: 80, atk: 125, def: 80, spa: 110, spd: 100, spe: 105},
		abilities: {0: "Intimidate", 1: "Punk Rock", H: "Sheer Force"},
		heightm: 1.6,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like"],
		otherFormes: ["Suisei-Mega"],
		formeOrder: ["Suisei", "Suisei-Mega"],
	},
	suiseimega: {
		num: 774,
		name: "Suisei-Mega",
		...
		types: ["Ice", "Rock"],
		gender: "F",
		baseStats: {hp: 80, atk: 145, def: 90, spa: 130, spd: 135, spe: 120},
		abilities: {0: "Pressure"},
		heightm: 1.6,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like"],
		requiredItem: "Suisite",
	},
	roboco: {
		num: 462,
		name: "Roboco",
		...
		gender: "F",
		baseStats: {hp: 85, atk: 110, def: 130, spa: 125, spd: 80, spe: 70},
		abilities: {0: "Motor Drive", 1: "Volt Absorb", H: "Electric Surge"},
		heightm: 1.54,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like", "Mineral"],
		otherFormes: ["Roboco-Mega"],
		formeOrder: ["Roboco", "Roboco-Mega"],
	},
	robocomega: {
		num: 462,
		name: "Roboco-Mega",
		...
		types: ["Steel", "Electric"],
		gender: "F",
		baseStats: {hp: 85, atk: 130, def: 170, spa: 145, spd: 90, spe: 80},
		abilities: {0: "Electric Surge"},
		heightm: 1.54,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like", "Mineral"],
		requiredItem: "Robocite",
	},
	azki: {
		num: 648,
		name: "AZKi",
		...
		abilities: {0: "Soundproof", 1: "Costar", H: "Punk Rock", S: "Diva"},
		heightm: 1.58,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
		otherFormes: ["AZKi-Mega"],
		formeOrder: ["AZKi", "AZKi-Mega"],
	},
	azkimega: {
		num: 648,
		name: "AZKi-Mega",
		...
		types: ["Normal", "Fairy"],
		gender: "F",
		baseStats: {hp: 90, atk: 100, def: 90, spa: 145, spd: 180, spe: 95},
		abilities: {0: "Misty Surge"},
		heightm: 1.58,
		weightkg: 55.5,
		color: "Red",
	...
	fubuki: {
		...
		types: ["Normal", "Ice"],
		gender: "F",
		baseStats: {hp: 80, atk: 125, def: 75, spa: 115, spd: 90, spe: 115},
		abilities: {0: "Friend Guard", 1: "Technician", H: "Tinted Lens"},
		heightm: 1.55,
		weightkg: 55.5,
		color: "White",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Fubuki-Mega", "Fubuzilla"],
		formeOrder: ["Fubuki", "Fubuki-Mega", "Fubuzilla"],
	},
	fubukimega: {
		num: 38,
		name: "Fubuki-Mega",
		...
		types: ["Normal", "Ice"],
		gender: "F",
		baseStats: {hp: 80, atk: 145, def: 85, spa: 135, spd: 120, spe: 135},
		abilities: {0: "Snow Warning"},
		heightm: 1.55,
		weightkg: 55.5,
		color: "White",
		eggGroups: ["Human-Like", "Field"],
		requiredItem: "Fubukite",
	},
	fubuzilla: {
		num: 38,
		name: "Fubuzilla",
		types: ["Ice", "Dragon"],
		gender: "F",
		baseStats: {hp: 160, atk: 150, def: 115, spa: 125, spd: 95, spe: 75},
		abilities: {0: "Pressure"},
		heightm: 155.55,
		weightkg: 555.5,
		color: "White",
	...
	matsuri: {
		...
		abilities: {0: "Hustle", 1: "Limber", H: "Unburden"},
		heightm: 1.52,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like"],
		otherFormes: ["Matsuri-Mega"],
		formeOrder: ["Matsuri", "Matsuri-Mega"],
	},
	matsurimega: {
		num: 192,
		name: "Matsuri-Mega",
		...
		types: ["Normal"],
		gender: "F",
		baseStats: {hp: 75, atk: 145, def: 85, spa: 145, spd: 125, spe: 125},
		abilities: {0: "Scrappy"},
		heightm: 1.52,
		weightkg: 55.5,
		color: "Brown",
	...
	haachama: {
		...
		types: ["Dark", "Bug"],
		gender: "F",
		baseStats: {hp: 80, atk: 130, def: 75, spa: 120, spd: 95, spe: 100},
		abilities: {0: "Unnerve", 1: "Prankster", H: "Mold Breaker"},
		heightm: 1.54,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like", "Bug"],
		otherFormes: ["Haachama-Mega"],
	...
	haachamamega: {
		...
		types: ["Dark", "Bug"],
		gender: "F",
		baseStats: {hp: 80, atk: 150, def: 95, spa: 140, spd: 125, spe: 110},
	...
	mel: {
		...
		types: ["Flying", "Dark"],
		gender: "F",
		baseStats: {hp: 85, atk: 125, def: 90, spa: 115, spd: 80, spe: 105},
		abilities: {0: "Sap Sipper", 1: "Cute Charm", H: "Strong Jaw"},
		heightm: 1.54,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like"],
		otherFormes: ["Mel-Mega"],
		formeOrder: ["Mel", "Mel-Mega"],
	},
	melmega: {
		num: 169,
		name: "Mel-Mega",
		...
		types: ["Flying", "Dark"],
		gender: "F",
		baseStats: {hp: 85, atk: 150, def: 115, spa: 135, spd: 95, spe: 120},
		abilities: {0: "Strong Jaw"},
		heightm: 1.54,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like"],
		requiredItem: "Melitite",
	},
	akirose: {
		num: 840,
		name: "Akirose",
		types: ["Psychic", "Fairy"],
		gender: "F",
		baseStats: {hp: 100, atk: 110, def: 95, spa: 120, spd: 115, spe: 60},
		abilities: {0: "Flower Veil", 1: "Dancer", H: "Magic Bounce"},
		heightm: 1.62,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like"],
		otherFormes: ["Akirose-Mega", "Fairy"],
		formeOrder: ["Akirose", "Akirose-Mega"],
	},
	akirosemega: {
		num: 840,
		name: "Akirose-Mega",
		...
		types: ["Psychic", "Fairy"],
		gender: "F",
		baseStats: {hp: 100, atk: 130, def: 110, spa: 140, spd: 150, spe: 70},
	...
	aqua: {
		...
		types: ["Water", "Fairy"],
		gender: "F",
		baseStats: {hp: 75, atk: 115, def: 75, spa: 125, spd: 120, spe: 90},
		abilities: {0: "Unaware", 1: "Prankster", H: "Sniper"},
		heightm: 1.48,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Water 1"],
		otherFormes: ["Aqua-Mega"],
	...
	aquamega: {
		...
		types: ["Water", "Fairy"],
		gender: "F",
		baseStats: {hp: 75, atk: 135, def: 85, spa: 145, spd: 155, spe: 105},
		abilities: {0: "Technician"},
		heightm: 1.48,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Water 1"],
		requiredItem: "Aquanite",
	},
	ayame: {
		num: 680,
		name: "Ayame",
		types: ["Dark", "Fighting"],
		gender: "F",
		baseStats: {hp: 85, atk: 125, def: 90, spa: 110, spd: 80, spe: 110},
		abilities: {0: "Flash Fire", 1: "Prankster", H: "Sharpness"},
		heightm: 1.52,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
		otherFormes: ["Ayame-Mega"],
		formeOrder: ["Ayame", "Ayame-Mega"],
	},
	ayamemega: {
		num: 680,
		name: "Ayame-Mega",
		...
		types: ["Dark", "Fighting"],
		gender: "F",
		baseStats: {hp: 85, atk: 155, def: 110, spa: 135, spd: 95, spe: 120},
		abilities: {0: "No Guard"},
		heightm: 1.52,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
		requiredItem: "Ayamite",
	},
	missingno: {
		num: 0,
		name: "MissingNo.",
	...
	choco: {
		...
		types: ["Fairy", "Dark"],
		gender: "F",
		baseStats: {hp: 130, atk: 110, def: 120, spa: 110, spd: 90, spe: 40},
		abilities: {0: "Healer", 1: "Natural Cure", H: "Hospitality"},
		heightm: 1.65,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like"],
		otherFormes: ["Choco-Mega"],
		formeOrder: ["Choco", "Choco-Mega"],
	},
	chocomega: {
		num: 242,
		name: "Choco-Mega",
		...
		types: ["Fairy", "Dark"],
		gender: "F",
		baseStats: {hp: 130, atk: 135, def: 150, spa: 135, spd: 110, spe: 40},
		abilities: {0: "Triage"},
		heightm: 1.65,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like"],
		requiredItem: "Chocolite",
	},
	shion: {
		num: 858,
		name: "Shion",
		types: ["Psychic", "Dark"],
		gender: "F",
		baseStats: {hp: 70, atk: 90, def: 70, spa: 140, spd: 125, spe: 105},
		abilities: {0: "Magic Bounce", 1: "Magic Guard", H: "Magician"},
		heightm: 1.45,
		weightkg: 55.5,
		color: "Black",
		eggGroups: ["Human-Like"],
		otherFormes: ["Shion-Mega"],
		formeOrder: ["Shion", "Shion-Mega"],
	},
	shionmega: {
		num: 858,
		name: "Shion-Mega",
		...
		types: ["Psychic", "Dark"],
		gender: "F",
		baseStats: {hp: 70, atk: 110, def: 80, spa: 165, spd: 160, spe: 115},
		abilities: {0: "Psychic Surge"},
		heightm: 1.45,
		weightkg: 55.5,
		color: "Black",
		eggGroups: ["Human-Like"],
		requiredItem: "Shionite",
	},
	subaru: {
		num: 912,
		name: "Subaru",
		types: ["Flying", "Fighting"],
		gender: "F",
		baseStats: {hp: 85, atk: 125, def: 95, spa: 110, spd: 80, spe: 105},
		abilities: {0: "Big Pecks", 1: "Hustle", H: "Justified"},
		heightm: 1.54,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like", "Water 1"],
		otherFormes: ["Subaru-Mega"],
		formeOrder: ["Subaru", "Subaru-Mega"],
	},
	subarumega: {
		num: 912,
		name: "Subaru-Mega",
		...
		types: ["Flying", "Fighting"],
		gender: "F",
		baseStats: {hp: 85, atk: 145, def: 130, spa: 130, spd: 90, spe: 120},
		abilities: {0: "Justified"},
		heightm: 1.54,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like", "Water 1"],
		requiredItem: "Subarite",
	},
	korone: {
		num: 506,
		name: "Korone",
		types: ["Normal", "Fighting"],
		gender: "F",
		baseStats: {hp: 80, atk: 130, def: 120, spa: 85, spd: 80, spe: 105},
		abilities: {0: "Iron Fist", 1: "Guard Dog", H: "Stamina"},
		heightm: 1.56,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Korone-Mega"],
		formeOrder: ["Korone", "Korone-Mega"],
	},
	koronemega: {
		num: 506,
		name: "Korone-Mega",
		...
		types: ["Normal", "Fighting"],
		gender: "F",
		baseStats: {hp: 80, atk: 150, def: 155, spa: 105, spd: 90, spe: 120},
		abilities: {0: "Unseen Fist"},
		heightm: 1.56,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like", "Field"],
		requiredItem: "Koronite",
	},
	mio: {
		num: 745,
		name: "Mio",
		types: ["Psychic"],
		gender: "F",
		baseStats: {hp: 100, atk: 120, def: 85, spa: 120, spd: 125, spe: 50},
		abilities: {0: "Frisk", 1: "Technician", H: "Mind's Eye"},
		heightm: 1.6,
		weightkg: 55.5,
		color: "Black",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Mio-Mega", "Mio-Hatotaurus"],
		formeOrder: ["Mio", "Mio-Mega", "Mio-Hatotaurus"],
	},
	miomega: {
		num: 745,
		name: "Mio-Mega",
		...
		types: ["Psychic"],
		gender: "F",
		baseStats: {hp: 100, atk: 140, def: 95, spa: 140, spd: 175, spe: 50},
		abilities: {0: "Parental Bond"},
		heightm: 1.6,
		weightkg: 55.5,
		color: "Black",
		eggGroups: ["Human-Like", "Field"],
		requiredItem: "Mionite",	
	},
	hatotaurus: {
		num: 519,
		name: "Hatotaurus",
		types: ["Flying"],
		gender: "M",
		baseStats: {hp: 115, atk: 160, def: 150, spa: 115, spd: 100, spe: 60},
	...
	okayu: {
		...
		types: ["Normal", "Grass"],
		gender: "F",
		baseStats: {hp: 80, atk: 120, def: 80, spa: 115, spd: 90, spe: 115},
		abilities: {0: "Gluttony", 1: "Harvest", H: "Skill Link"},
		heightm: 1.52,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Okayu-Mega"],
		formeOrder: ["Okayu", "Okayu-Mega"],
	},
	okayumega: {
		num: 300,
		name: "Okayu-Mega",
		...
		types: ["Normal", "Grass"],
		gender: "F",
		baseStats: {hp: 80, atk: 145, def: 90, spa: 140, spd: 110, spe: 135},
		abilities: {0: "Technician"},
		heightm: 1.52,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like", "Field"],
		requiredItem: "Okayunite",
	},
	pekora: {
		num: 428,
		name: "Pekora",
		types: ["Dark", "Grass"],
		gender: "F",
		baseStats: {hp: 75, atk: 125, def: 75, spa: 125, spd: 75, spe: 125},
		abilities: {0: "Prankster", 1: "Harvest", H: "Cheek Pouch"},
		heightm: 1.53,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Field"],
	...
	pekoramega: {
		...
		types: ["Dark", "Grass"],
		gender: "F",
		baseStats: {hp: 75, atk: 145, def: 85, spa: 145, spd: 110, spe: 140},
		abilities: {0: "Prankster"},
		heightm: 1.53,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Field"],
		requiredItem: "Pekorite",
	},
	pekorawarcriminal: {
		num: 427,
	...
	noel: {
		...
		color: "Gray",
		eggGroups: ["Human-Like"],
		otherFormes: ["Noel-Mega"],
		formeOrder: ["Noel", "Noel-Mega"],
	},
	noelmega: {
		num: 823,
		name: "Noel-Mega",
		...
		types: ["Fighting", "Steel"],
		gender: "F",
		baseStats: {hp: 110, atk: 155, def: 190, spa: 100, spd: 105, spe: 40},
		abilities: {0: "Defiant"},
		heightm: 1.58,
		weightkg: 55.5,
		color: "Gray",
	...
	rushia: {
		...
		types: ["Dark", "Bug"],
		gender: "F",
		baseStats: {hp: 75, atk: 120, def: 75, spa: 115, spd: 110, spe: 105},
		abilities: {0: "Berserk", 1: "Anger Point", H: "Pressure"},
		heightm: 1.43,
		weightkg: 55.5,
		color: "Green",
		eggGroups: ["Human-Like"],
		otherFormes: ["Rushia-Mega"],
	...
	rushiamega: {
		...
		types: ["Dark", "Bug"],
		gender: "F",
		baseStats: {hp: 75, atk: 145, def: 85, spa: 140, spd: 140, spe: 115},
		abilities: {0: "Sheer Force"},
		heightm: 1.43,
		weightkg: 55.5,
		color: "Green",
		eggGroups: ["Human-Like"],
		requiredItem: "Rushianite",
	},
	flare: {
		num: 724,
		name: "Flare",
		types: ["Fairy", "Fighting"],
		gender: "F",
		baseStats: {hp: 85, atk: 125, def: 80, spa: 120, spd: 110, spe: 80},
		abilities: {0: "Long Reach", 1: "Skill Link", H: "Flash Fire"},
		heightm: 1.58,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like", "Fairy"],
		otherFormes: ["Flare-Mega"],
		formeOrder: ["Flare", "Flare-Mega"],
	},
	flaremega: {
		num: 724,
		name: "Flare-Mega",
		...
		types: ["Fairy", "Fighting"],
		gender: "F",
		baseStats: {hp: 85, atk: 145, def: 95, spa: 140, spd: 145, spe: 90},
		abilities: {0: "Drought"},
		heightm: 1.58,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like", "Fairy"],
		requiredItem: "Flarite",
	},
	marine: {
		num: 999,
		name: "Marine",
		types: ["Water"],
		gender: "F",
		baseStats: {hp: 100, atk: 125, def: 120, spa: 115, spd: 75, spe: 65},
		abilities: {0: "Cute Charm", 1: "Hydration", H: "Prankster"},
		heightm: 1.5,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like", "Water 1"],
		otherFormes: ["Marine-Mega"],
		formeOrder: ["Marine", "Marine-Mega"],
	},
	marinemega: {
		num: 999,
		name: "Marine-Mega",
		...
		types: ["Water"],
		gender: "F",
		baseStats: {hp: 100, atk: 145, def: 150, spa: 135, spd: 95, spe: 75},
		abilities: {0: "Good as Gold"},
		heightm: 1.5,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like", "Water 1"],
		requiredItem: "Marinite",
	},
	coco: {
		num: 149,
		name: "Coco",
		types: ["Dragon", "Flying"],
		gender: "F",
		baseStats: {hp: 125, atk: 130, def: 120, spa: 95, spd: 80, spe: 50},
		abilities: {0: "Guts", 1: "Curious Medicine", H: "Mold Breaker"},
		heightm: 1.8,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like", "Dragon"],
		otherFormes: ["Coco-Mega", "Coco-Draco"],
	...
	cocomega: {
		...
		types: ["Dragon", "Flying"],
		gender: "F",
		baseStats: {hp: 125, atk: 160, def: 155, spa: 115, spd: 95, spe: 50},
		abilities: {0: "Dragon's Maw"},
		heightm: 8.8,
		weightkg: 555.5,
		color: "Brown",
	...
	cocodraco: {
		...
		types: ["Dragon", "Flying"],
		gender: "F",
		baseStats: {hp: 150, atk: 175, def: 155, spa: 125, spd: 75, spe: 30},
	...
	kanata: {
		...
		types: ["Fairy", "Flying"],
		gender: "F",
		baseStats: {hp: 75, atk: 100, def: 75, spa: 120, spd: 125, spe: 105},
		abilities: {0: "Serene Grace", 1: "Iron Fist", H: "Gorilla Tactics"},
		heightm: 1.49,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Fairy"],
		otherFormes: ["Kanata-Mega"],
		formeOrder: ["Kanata", "Kanata-Mega"],
	},
	kanatamega: {
		num: 468,
		name: "Kanata-Mega",
		...
		types: ["Fairy", "Flying"],
		gender: "F",
		baseStats: {hp: 75, atk: 120, def: 85, spa: 140, spd: 165, spe: 115},
		abilities: {0: "Misty Surge"},
		heightm: 1.49,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Fairy"],
		requiredItem: "Kanatite",
	},
	watame: {
		num: 179,
		name: "Watame",
		types: ["Normal"],
		gender: "F",
		baseStats: {hp: 95, atk: 110, def: 100, spa: 120, spd: 125, spe: 50},
		abilities: {0: "Fluffy", 1: "Soundproof", H: "Serene Grace"},
		heightm: 1.51,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Watame-Mega"],
		formeOrder: ["Watame", "Watame-Mega"],
	},
	watamemega: {
		num: 179,
		name: "Watame-Mega",
		...
		gender: "F",
		baseStats: {hp: 95, atk: 130, def: 125, spa: 140, spd: 160, spe: 50},
		abilities: {0: "Punk Rock"},
		heightm: 1.51,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like", "Field"],
		requiredItem: "Watamite",
	},
	luna: {
		num: 869,
		name: "Luna",
		types: ["Fairy"],
		gender: "F",
		baseStats: {hp: 70, atk: 95, def: 70, spa: 125, spd: 135, spe: 105},
		abilities: {0: "Aroma Veil", 1: "Sweet Veil", H: "Supersweet Syrup"},
		heightm: 1.4,
		weightkg: 55.5,
		color: "Pink",
		eggGroups: ["Human-Like"],
		otherFormes: ["Luna-Mega"],
		formeOrder: ["Luna", "Luna-Mega"],
	},
	lunamega: {
		num: 869,
		name: "Luna-Mega",
		...
		types: ["Fairy"],
		gender: "F",
		baseStats: {hp: 70, atk: 115, def: 80, spa: 150, spd: 170, spe: 115},
		abilities: {0: "Queenly Majesty"},
		heightm: 1.4,
		weightkg: 55.5,
		color: "Pink",
		eggGroups: ["Human-Like"],
		requiredItem: "Lunarite",
	},
	towa: {
		num: 570,
		name: "Towa",
		...
		abilities: {0: "Contrary", 1: "Serene Grace", H: "Levitate"},
		heightm: 1.5,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like"],
		otherFormes: ["Towa-Mega"],
		formeOrder: ["Towa", "Towa-Mega"],
	},
	towamega: {
		num: 570,
		name: "Towa-Mega",
		...
		types: ["Dark", "Fairy"],
		gender: "F",
		baseStats: {hp: 85, atk: 150, def: 95, spa: 145, spd: 110, spe: 115},
		abilities: {0: "Sniper"},
		heightm: 1.5,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like"],
		requiredItem: "Towasite",
	},
	polka: {
		num: 653,
		name: "Polka",
		types: ["Normal"],
		gender: "F",
		baseStats: {hp: 80, atk: 125, def: 80, spa: 115, spd: 80, spe: 120},
		abilities: {0: "Hustle", 1: "Prankster", H: "Dancer"},
		heightm: 1.53,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Polka-Mega"],
		formeOrder: ["Polka", "Polka-Mega"],
	},
	polkamega: {
		num: 653,
		name: "Polka-Mega",
		...
		types: ["Normal"],
		gender: "F",
		baseStats: {hp: 80, atk: 145, def: 90, spa: 135, spd: 105, spe: 145},
		abilities: {0: "Technician"},
		heightm: 1.53,
		weightkg: 55.5,
		color: "Red",
	...
	botan: {
		...
		types: ["Fighting"],
		gender: "F",
		baseStats: {hp: 115, atk: 130, def: 115, spa: 90, spd: 80, spe: 70},
		abilities: {0: "Technician", 1: "Skill Link", H: "Sniper"},
		heightm: 1.66,
		weightkg: 55.5,
		color: "Gray",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Botan-Mega"],
	...
	botanmega: {
		...
		types: ["Fighting"],
		gender: "F",
		baseStats: {hp: 115, atk: 150, def: 155, spa: 115, spd: 95, spe: 70},
		abilities: {0: "Sniper"},
		heightm: 1.66,
		weightkg: 55.5,
		color: "Gray",
		eggGroups: ["Human-Like", "Field"],
		requiredItem: "Botanite",
	},
	lamy: {
		num: 613,
		name: "Lamy",
		types: ["Ice"],
		gender: "F",
		baseStats: {hp: 80, atk: 95, def: 80, spa: 120, spd: 130, spe: 95},
		abilities: {0: "Ice Body", 1: "Water Absorb", H: "Snow Warning"},
		heightm: 1.58,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Fairy"],
		otherFormes: ["Lamy-Mega"],
		formeOrder: ["Lamy", "Lamy-Mega"],
	},
	lamymega: {
		num: 613,
		name: "Lamy-Mega",
		...
		types: ["Ice", "Fairy"],
		gender: "F",
		baseStats: {hp: 80, atk: 115, def: 90, spa: 140, spd: 170, spe: 105},
		abilities: {0: "Snow Warning"},
		heightm: 1.58,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Fairy"],
		requiredItem: "Lamilite",
	},
	nene: {
		num: 87,
		name: "Nene",
		types: ["Fairy"],
		gender: "F",
		baseStats: {hp: 85, atk: 115, def: 85, spa: 120, spd: 125, spe: 70},
		abilities: {0: "Unaware", 1: "Tough Claws", H: "Swift Swim"},
		heightm: 1.59,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like"],
		otherFormes: ["Nene-Mega"],
		formeOrder: ["Nene", "Nene-Mega"],
	},
	nenemega: {
		num: 87,
		name: "Nene-Mega",
		...
		types: ["Fairy", "Water"],
		gender: "F",
		baseStats: {hp: 85, atk: 135, def: 95, spa: 140, spd: 165, spe: 80},
		abilities: {0: "Misty Surge"},
		heightm: 1.59,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like"],
		requiredItem: "Nenenite",
	},
	aloe: {
		num: 860,
		name: "Aloe",
		...
		abilities: {0: "Prankster", 1: "Contrary", H: "Punk Rock"},
		heightm: 1.5,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like"],
		otherFormes: ["Aloe-Mega"],
		formeOrder: ["Aloe", "Aloe-Mega"],
	},
	aloemega: {
		num: 860,
		name: "Aloe-Mega",
		...
		types: ["Dark", "Fairy"],
		gender: "F",
		baseStats: {hp: 80, atk: 145, def: 95, spa: 140, spd: 125, spe: 115},
		abilities: {0: "Punk Rock"},
		heightm: 1.5,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like"],
		requiredItem: "Aloelite",
	},
	iroha: {
		num: 162,
		name: "Iroha",
		...
		abilities: {0: "Defiant", 1: "Scrappy", H: "Sharpness"},
		heightm: 1.56,
		weightkg: 55.5,
		color: "Green",
		eggGroups: ["Human-Like"],
		otherFormes: ["Iroha-Mega"],
		formeOrder: ["Iroha", "Iroha-Mega"],
	},
	irohamega: {
		num: 162,
		name: "Iroha-Mega",
		...
		types: ["Fighting"],
		gender: "F",
		baseStats: {hp: 80, atk: 155, def: 115, spa: 135, spd: 95, spe: 120},
		abilities: {0: "Sharpness"},
		heightm: 1.56,
		weightkg: 55.5,
		color: "Green",
		eggGroups: ["Human-Like"],
		requiredItem: "Irohite",
	},
	koyori: {
		num: 196,
		name: "Koyori",
		types: ["Psychic"],
		gender: "F",
		baseStats: {hp: 75, atk: 105, def: 80, spa: 120, spd: 115, spe: 105},
		abilities: {0: "Hustle", 1: "Technician", H: "Psychic Surge"},
		heightm: 1.53,
		weightkg: 55.5,
		color: "Pink",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Koyori-Mega"],
		formeOrder: ["Koyori", "Koyori-Mega"],
	},
	koyorimega: {
		num: 196,
		name: "Koyori-Mega",
		...
		types: ["Psychic"],
		gender: "F",
		baseStats: {hp: 75, atk: 125, def: 90, spa: 140, spd: 150, spe: 120},
		abilities: {0: "Psychic Surge"},
		heightm: 1.53,
		weightkg: 55.5,
		color: "Pink",
		eggGroups: ["Human-Like", "Field"],
		requiredItem: "Koyorite",
	},
	laplus: {
		num: 821,
		name: "Laplus",
		...
		abilities: {0: "Magic Guard", 1: "Magic Bounce", H: "Moxie"},
		heightm: 1.39,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like"],
		otherFormes: ["Laplus-Mega"],
		formeOrder: ["Laplus", "Laplus-Mega"],
	},
	laplusmega: {
		num: 821,
		name: "Laplus-Mega",
		...
		types: ["Psychic", "Dark"],
		gender: "F",
		baseStats: {hp: 70, atk: 155, def: 80, spa: 145, spd: 180, spe: 70},
		abilities: {0: "Psychic Surge"},
		heightm: 1.39,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like"],
		requiredItem: "Laplusite",	
	},
	lui: {
		num: 628,
		name: "Lui",
		...
		otherFormes: ["Lui-Mega"],
		formeOrder: ["Lui", "Lui-Mega"],
	},
	luimega: {
		num: 628,
		name: "Lui-Mega",
		...
		types: ["Flying", "Psychic"],
		gender: "F",
		baseStats: {hp: 110, atk: 145, def: 125, spa: 140, spd: 100, spe: 80},
		abilities: {0: "Tinted Lens"},
		heightm: 1.61,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like", "Flying"],
		requiredItem: "Luinite",
	},
	chloe: {
		num: 963,
		name: "Chloe",
		types: ["Water", "Dark"],
		gender: "F",
		baseStats: {hp: 95, atk: 125, def: 115, spa: 110, spd: 75, spe: 80},
		abilities: {0: "Screen Cleaner", 1: "Water Veil", H: "Stench"},
		heightm: 1.48,
		weightkg: 55.5,
		color: "Gray",
		eggGroups: ["Human-Like", "Water 2"],
		otherFormes: ["Chloe-Mega"],
		formeOrder: ["Chloe", "Chloe-Mega"],
	},
	chloemega: {
		num: 963,
		name: "Chloe-Mega",
		...
		types: ["Water", "Dark"],
		gender: "F",
		baseStats: {hp: 95, atk: 150, def: 140, spa: 135, spd: 85, spe: 95},
		abilities: {0: "Swift Swim"},
		heightm: 1.48,
		weightkg: 55.5,
		color: "Gray",
		eggGroups: ["Human-Like", "Water 2"],
		requiredItem: "Chloelite",
	},
	moona: {
		num: 337,
		name: "Moona",
		types: ["Fairy", "Psychic"],
		gender: "F",
		baseStats: {hp: 100, atk: 110, def: 85, spa: 125, spd: 130, spe: 50},
		abilities: {0: "Dazzling", 1: "Magic Bounce", H: "Serene Grace"},
		heightm: 1.65,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like"],
		otherFormes: ["Moona-Mega", "Moona-Hoshinova"],
		formeOrder: ["Moona", "Moona-Mega", "Moona-Hoshinova"],
	},
	moonamega: {
		num: 337,
		name: "Moona-Mega",
		...
		types: ["Fairy", "Psychic"],
		gender: "F",
		baseStats: {hp: 100, atk: 130, def: 95, spa: 145, spd: 180, spe: 50},
		abilities: {0: "Misty Surge"},
		heightm: 1.65,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like"],
		requiredItem: "Moonite",
	},
	moonahoshinova: {
		num: 792,
		...
		types: ["Dark", "Psychic"],
		gender: "F",
		baseStats: {hp: 100, atk: 150, def: 110, spa: 130, spd: 140, spe: 50},
	...
	iofi: {
		...
		types: ["Psychic"],
		gender: "F",
		baseStats: {hp: 85, atk: 120, def: 85, spa: 120, spd: 100, spe: 90},
		abilities: {0: "Pastel Veil", 1: "Color Change", H: "Trace"},
		heightm: 1.5,
		weightkg: 55.5,
		color: "Pink",
		eggGroups: ["Human-Like"],
		otherFormes: ["Iofi-Mega"],
	...
	iofimega: {
		...
		types: ["Psychic"],
		gender: "F",
		baseStats: {hp: 85, atk: 145, def: 95, spa: 145, spd: 130, spe: 100},
		abilities: {0: "Protean"},
		heightm: 1.5,
		weightkg: 55.5,
		color: "Pink",
	...
	risu: {
		...
		color: "Brown",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Risu-Mega", "Risusaurus"],
		formeOrder: ["Risu", "Risu-Mega", "Risusaurus"],
	},
	risumega: {
		num: 417,
		name: "Risu-Mega",
		...
		types: ["Grass", "Psychic"],
		gender: "F",
		baseStats: {hp: 75, atk: 140, def: 85, spa: 130, spd: 125, spe: 145},
		abilities: {0: "Grassy Surge"},
		heightm: 1.53,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like", "Field"],
		requiredItem: "Risurite",
	},
	risusaurus: {
		num: 820,
		name: "Risusaurus",
		types: ["Dragon"],
		gender: "F",
		baseStats: {hp: 125, atk: 155, def: 120, spa: 145, spd: 95, spe: 80},
	...
	ollie: {
		...
		types: ["Ghost", "Normal"],
		gender: "F",
		baseStats: {hp: 75, atk: 125, def: 75, spa: 120, spd: 85, spe: 120},
		abilities: {0: "Hustle", 1: "Reckless", H: "Mummy"},
		heightm: 1.62,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
		otherFormes: ["Ollie-Mega", "Olivia"],
		formeOrder: ["Ollie", "Ollie-Mega", "Olivia"],
	},
	olliemega: {
		num: 47,
		name: "Ollie-Mega",
		...
		types: ["Ghost", "Normal"],
		gender: "F",
		baseStats: {hp: 75, atk: 150, def: 85, spa: 145, spd: 105, spe: 140},
		abilities: {0: "Hustle"},
		heightm: 1.62,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
		requiredItem: "Ollilite",
	},
	olivia: {
		num: 327,
		name: "Olivia",
		types: ["Normal"],
		gender: "F",
		baseStats: {hp: 85, atk: 120, def: 80, spa: 115, spd: 95, spe: 105},
	...
	reine: {
		...
		types: ["Flying", "Psychic"],
		gender: "F",
		baseStats: {hp: 100, atk: 110, def: 95, spa: 125, spd: 120, spe: 50},
		abilities: {0: "Big Pecks", 1: "Magic Bounce", H: "Iron Fist"},
		heightm: 1.72,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Flying"],
		otherFormes: ["Reine-Mega"],
		formeOrder: ["Reine", "Reine-Mega"],
	},
	reinemega: {
		num: 581,
		name: "Reine-Mega",
		...
		types: ["Flying", "Psychic"],
		gender: "F",
		baseStats: {hp: 100, atk: 130, def: 110, spa: 145, spd: 165, spe: 50},
		abilities: {0: "Psychic Surge"},
		heightm: 1.72,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Flying"],
		requiredItem: "Reinite",
	},
	anya: {
		num: 679,
		name: "Anya",
		types: ["Steel", "Fighting"],
		gender: "F",
		baseStats: {hp: 75, atk: 140, def: 80, spa: 110, spd: 120, spe: 75},
		abilities: {0: "Magic Guard", 1: "Sharpness", H: "Intrepid Sword"},
		heightm: 1.47,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like", "Mineral"],
		otherFormes: ["Anya-Mega"],
		formeOrder: ["Anya", "Anya-Mega"],
	},
	anyamega: {
		num: 679,
		name: "Anya-Mega",
		...
		types: ["Steel", "Fighting"],
		gender: "F",
		baseStats: {hp: 75, atk: 170, def: 95, spa: 130, spd: 155, spe: 75},
		abilities: {0: "Sharpness"},
		heightm: 1.47,
		weightkg: 55.5,
		color: "Brown",
	...
	zeta: {
		...
		types: ["Dark", "Psychic"],
		gender: "F",
		baseStats: {hp: 80, atk: 120, def: 75, spa: 120, spd: 95, spe: 110},
		abilities: {0: "Analytic", 1: "Infiltrator", H: "Protean"},
		heightm: 1.55,
		weightkg: 55.5,
		color: "Gray",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Zeta-Mega"],
	...
	zetamega: {
		...
		types: ["Dark", "Psychic"],
		gender: "F",
		baseStats: {hp: 80, atk: 140, def: 85, spa: 140, spd: 125, spe: 130},
		abilities: {0: "Infiltrator"},
		heightm: 1.55,
		weightkg: 55.5,
		color: "Gray",
		eggGroups: ["Human-Like", "Field"],
		requiredItem: "Zetanite",	
	},
	kaela: {
		num: 959,
		name: "Kaela",
		...
		abilities: {0: "Pressure", 1: "Tinted Lens", H: "Super Luck"},
		heightm: 1.73,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like"],
		otherFormes: ["Kaela-Mega"],
		formeOrder: ["Kaela", "Kaela-Mega"],
	},
	kaelamega: {
		num: 959,
		name: "Kaela-Mega",
		...
		types: ["Steel"],
		gender: "F",
		baseStats: {hp: 120, atk: 145, def: 200, spa: 100, spd: 90, spe: 45},
		abilities: {0: "Pressure"},
		heightm: 1.73,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like"],
		requiredItem: "Kaelite",
	},
	kobo: {
		num: 817,
		name: "Kobo",
		...
		abilities: {0: "Storm Drain", 1: "Water Absorb", H: "Drizzle"},
		heightm: 1.5,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like"],
		otherFormes: ["Kobo-Mega"],
	...
	kobomega: {
		...
		types: ["Water"],
		gender: "F",
		baseStats: {hp: 75, atk: 130, def: 85, spa: 140, spd: 165, spe: 105},
		abilities: {0: "Drizzle"},
		heightm: 1.5,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like"],
		requiredItem: "Kobonite",
	},
	gura: {
		num: 443,
		name: "Gura",
		types: ["Water"],
		gender: "F",
		baseStats: {hp: 75, atk: 120, def: 75, spa: 115, spd: 80, spe: 135},
		abilities: {0: "Unaware", 1: "Strong Jaw", H: "Swift Swim"},
		heightm: 1.41,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Water 2"],
		otherFormes: ["Gura-Mega", "Gura-Gawr", "Gura-Zilla"],
		formeOrder: ["Gura", "Gura-Mega", "Gura-Gawr", "Gura-Zilla"],
	},
	guramega: {
		num: 443,
		name: "Gura-Mega",
		...
		types: ["Water"],
		gender: "F",
		baseStats: {hp: 75, atk: 140, def: 85, spa: 135, spd: 110, spe: 155},
		abilities: {0: "Drizzle"},
		heightm: 1.41,
		weightkg: 55.5,
		color: "Blue",
	...
	guragawr: {
		...
		abilities: {0: "Anger Point", 1: "Intimidate", H: "Strong Jaw"},
		heightm: 1.41,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like", "Water 2"],
	...
	gurazilla: {
		...
		types: ["Water", "Dragon"],
		gender: "F",
		baseStats: {hp: 110, atk: 155, def: 145, spa: 100, spd: 115, spe: 75},
		abilities: {0: "Strong Jaw"},
		heightm: 41.41,
		weightkg: 255.5,
		color: "Green",
	...
	ame: {
		...
		gender: "F",
		baseStats: {hp: 80, atk: 125, def: 80, spa: 120, spd: 90, spe: 105},
		abilities: {0: "Anger Point", 1: "Sniper", H: "Poison Point"},
		heightm: 1.5,
		weightkg: 55.5,
		color: "Yellow",
		eggGroups: ["Human-Like"],
		otherFormes: ["Ame-Mega", "Ame-Smol", "Ame-Buff", "Ame-Bee"],
		formeOrder: ["Ame", "Ame-Mega", "Ame-Smol", "Ame-Buff", "Ame-Bee"],
	},
	amemega: {
		num: 835,
		name: "Ame-Mega",
	...
	calliope: {
		...
		types: ["Ghost"],
		gender: "F",
		baseStats: {hp: 100, atk: 120, def: 95, spa: 120, spd: 115, spe: 50},
		abilities: {0: "Sharpness", 1: "Guts", H: "Punk Rock"},
		heightm: 1.67,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
		otherFormes: ["Calliope-Mega"],
		formeOrder: ["Calliope", "Calliope-Mega"],
	},
	calliopemega: {
		num: 355,
		name: "Calliope-Mega",
		baseSpecies: "Calliope",
		forme: "Mega",
		types: ["Ghost"],
		gender: "F",
		baseStats: {hp: 100, atk: 140, def: 115, spa: 140, spd: 155, spe: 50},
		abilities: {0: "Perish Body"},
		heightm: 1.67,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
		requiredItem: "Callite",
	},
	ina: {
		num: 686,
		name: "Ina",
		...
		abilities: {0: "Suction Cups", 1: "Serene Grace", H: "Magic Guard"},
		heightm: 1.57,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like", "Fairy"],
		otherFormes: ["Ina-Mega"],
	...
	inamega: {
		...
		types: ["Psychic", "Water"],
		gender: "F",
		baseStats: {hp: 80, atk: 140, def: 85, spa: 150, spd: 180, spe: 65},
		abilities: {0: "Psychic Surge"},
		heightm: 1.57,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like", "Fairy"],
		requiredItem: "Inanite",
	},
	kiara: {
		num: 257,
		name: "Kiara",
		...
		abilities: {0: "Big Pecks", 1: "Flame Body", H: "Sharpness"},
		heightm: 1.65,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like", "Flying"],
		otherFormes: ["Kiara-Mega"],
		formeOrder: ["Kiara", "Kiara-Mega"],
	},
	kiaramega: {
		num: 257,
		name: "Kiara-Mega",
		...
		types: ["Fire", "Flying"],
		gender: "F",
		baseStats: {hp: 100, atk: 140, def: 110, spa: 140, spd: 150, spe: 60},
		abilities: {0: "Drought"},
		heightm: 1.65,
		weightkg: 55.5,
		color: "Brown",
	...
	irys: {
		...
		abilities: {0: "Defiant", 1: "Competitive", H: "Levitate"},
		heightm: 1.66,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like", "Mineral"],
		otherFormes: ["IRyS-Mega"],
		formeOrder: ["IRyS", "IRyS-Mega"],
	},
	irysmega: {
		num: 293,
		name: "IRyS-Mega",
		...
		types: ["Fairy", "Dark"],
		gender: "F",
		baseStats: {hp: 80, atk: 140, def: 90, spa: 140, spd: 180, spe: 70},
		abilities: {0: "Serene Grace"},
		heightm: 1.66,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like", "Mineral"],
		requiredItem: "IRySite",
	},
	sana: {
		num: 926,
		name: "Sana",
		...
		abilities: {0: "Solar Power", 1: "Earth Eater", H: "Magic Bounce"},
		heightm: 1.69,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like"],
		otherFormes: ["Sana-Mega"],
		formeOrder: ["Sana", "Sana-Mega"],
	},
	sanamega: {
		num: 926,
		name: "Sana-Mega",
		...
		types: ["Psychic"],
		gender: "F",
		baseStats: {hp: 140, atk: 100, def: 150, spa: 140, spd: 130, spe: 40},
		abilities: {0: "Huge Power"},
		heightm: 169.69,
		weightkg: 6969.69,
		color: "Brown",
		eggGroups: ["Human-Like"],
		requiredItem: "Sanalite",
	},
	fauna: {
		num: 585,
		name: "Fauna",
		types: ["Grass"],
		gender: "F",
		baseStats: {hp: 85, atk: 105, def: 85, spa: 120, spd: 145, spe: 60},
		abilities: {0: "Sap Sipper", 1: "Cloud Nine", H: "Grassy Surge"},
		heightm: 1.64,
		weightkg: 55.5,
		color: "Green",
		eggGroups: ["Human-Like", "Grass"],
		otherFormes: ["Fauna-Mega"],
		formeOrder: ["Fauna", "Fauna-Mega"],
	},
	faunamega: {
		num: 585,
		name: "Fauna-Mega",
		...
		types: ["Grass", "Psychic"],
		gender: "F",
		baseStats: {hp: 85, atk: 125, def: 95, spa: 145, spd: 190, spe: 60},
		abilities: {0: "Grassy Surge"},
		heightm: 1.64,
		weightkg: 55.5,
		color: "Green",
	...
	kronii: {
		...
		color: "Blue",
		eggGroups: ["Human-Like"],
		otherFormes: ["Kronii-Mega", "Kronii-Boros"],
		formeOrder: ["Kronii", "Kronii-Mega", "Kronii-Boros"],
	},
	kroniimega: {
		num: 187,
		name: "Kronii-Mega",
		...
		types: ["Psychic", "Steel"],
		gender: "F",
		baseStats: {hp: 105, atk: 145, def: 125, spa: 135, spd: 150, spe: 40},
		abilities: {0: "Sand Stream"},
		heightm: 1.68,
		weightkg: 55.5,
		color: "Blue",
	...
	kroniiboros: {
		...
		abilities: {0: "Cute Charm", 1: "Own Tempo", H: "Marvel Scale"},
		heightm: 0.68,
		weightkg: 5.5,
		color: "White",
		eggGroups: ["Dragon"],
	...
	mumei: {
		...
		gender: "F",
		baseStats: {hp: 80, atk: 125, def: 80, spa: 120, spd: 90, spe: 105},
		abilities: {0: "Big Pecks", 1: "Unaware", H: "Harvest"},
		heightm: 1.56,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like", "Flying"],
		otherFormes: ["Mumei-Mega", "Mumei-Evil"],
		formeOrder: ["Mumei", "Mumei-Mega", "Mumei-Evil"],
	},
	mumeimega: {
		num: 164,
		name: "Mumei-Mega",
		...
		types: ["Flying", "Dark"],
		gender: "F",
		baseStats: {hp: 80, atk: 150, def: 90, spa: 145, spd: 120, spe: 115},
		abilities: {0: "Sharpness"},
		heightm: 1.56,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like", "Flying"],
		requiredItem: "Mumeinite",
	},
	mumeievil: {
		num: 717,
		name: "Mumei-Evil",
	...
	bae: {
		...
		types: ["Dark"],
		gender: "F",
		baseStats: {hp: 80, atk: 125, def: 80, spa: 115, spd: 70, spe: 130},
		abilities: {0: "Cheek Pouch", 1: "Hustle", H: "Strong Jaw"},
		heightm: 1.49,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Bae-Mega"],
		formeOrder: ["Bae", "Bae-Mega"],
	},
	baemega: {
		num: 20,
		name: "Bae-Mega",
		...
		types: ["Dark"],
		gender: "F",
		baseStats: {hp: 80, atk: 145, def: 105, spa: 140, spd: 80, spe: 150},
		abilities: {0: "Mold Breaker"},
		heightm: 1.49,
		weightkg: 55.5,
		color: "Red",
	...
	shiori: {
		...
		types: ["Dark", "Psychic"],
		gender: "F",
		baseStats: {hp: 90, atk: 120, def: 85, spa: 125, spd: 110, spe: 70},
		abilities: {0: "Analytic", 1: "Frisk", H: "Pressure"},
		heightm: 1.63,
		weightkg: 55.5,
		color: "Gray",
		eggGroups: ["Human-Like"],
		otherFormes: ["Shiori-Mega"],
		formeOrder: ["Shiori", "Shiori-Mega"],
	},
	shiorimega: {
		num: 576,
		name: "Shiori-Mega",
		...
		types: ["Dark", "Psychic"],
		gender: "F",
		baseStats: {hp: 90, atk: 140, def: 95, spa: 145, spd: 150, spe: 80},
		abilities: {0: "Cursed Body"},
		heightm: 1.63,
		weightkg: 55.5,
		color: "Gray",
		eggGroups: ["Human-Like"],
		requiredItem: "Shiorite",
	},
	bijou: {
		num: 719,
		name: "Bijou",
		types: ["Rock", "Ground"],
		gender: "F",
		baseStats: {hp: 70, atk: 105, def: 140, spa: 120, spd: 115, spe: 50},
		abilities: {0: "Solid Rock", 1: "Levitate", H: "Sand Stream"},
		heightm: 1.4,
		weightkg: 55.5,
		color: "Purple",
		eggGroups: ["Human-Like", "Mineral"],
		otherFormes: ["Bijou-Mega"],
		formeOrder: ["Bijou", "Bijou-Mega"],
	},
	bijoumega: {
		num: 719,
		name: "Bijou-Mega",
		...
		types: ["Rock", "Ground"],
		gender: "F",
		baseStats: {hp: 70, atk: 125, def: 180, spa: 140, spd: 135, spe: 50},
		abilities: {0: "Sand Stream"},
		heightm: 1.4,
		weightkg: 55.5,
		color: "Purple",
	...
	nerissa: {
		...
		types: ["Flying", "Dark"],
		gender: "F",
		baseStats: {hp: 110, atk: 120, def: 95, spa: 115, spd: 105, spe: 55},
		abilities: {0: "Big Pecks", 1: "Sharpness", H: "Punk Rock"},
		heightm: 1.75,
		weightkg: 55.5,
		color: "Black",
		eggGroups: ["Human-Like", "Flying"],
		otherFormes: ["Nerissa-Mega"],
		formeOrder: ["Nerissa", "Nerissa-Mega"],
	},
	nerissamega: {
		num: 822,
		name: "Nerissa-Mega",
		...
		types: ["Flying", "Dark"],
		gender: "F",
		baseStats: {hp: 110, atk: 140, def: 120, spa: 135, spd: 140, spe: 55},
		abilities: {0: "No Guard"},
		heightm: 1.75,
		weightkg: 55.5,
		color: "Black",
		eggGroups: ["Human-Like", "Flying"],
		requiredItem: "Nerissite",
	},
	mococo: {
		num: 228,
		name: "Mococo",
		types: ["Dark"],
		gender: "F",
		baseStats: {hp: 80, atk: 125, def: 75, spa: 120, spd: 75, spe: 125},
		abilities: {0: "Guard Dog", 1: "Tough Claws", H: "Defiant"},
		heightm: 1.55,
		weightkg: 55.5,
		color: "Pink",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Mococo-Mega"],
		formeOrder: ["Mococo", "Mococo-Mega"],
	},
	mococomega: {
		num: 228,
		name: "Mococo-Mega",
		...
		types: ["Dark"],
		gender: "F",
		baseStats: {hp: 80, atk: 150, def: 95, spa: 145, spd: 85, spe: 145},
		abilities: {0: "Defiant"},
		heightm: 1.55,
		weightkg: 55.5,
		color: "Pink",
		eggGroups: ["Human-Like", "Field"],
		requiredItem: "Mococite",
	},
	fuwawa: {
		num: 228,
		name: "Fuwawa",
		types: ["Dark"],
		gender: "F",
		baseStats: {hp: 80, atk: 125, def: 120, spa: 80, spd: 135, spe: 60},
		abilities: {0: "Guard Dog", 1: "Tough Claws", H: "Fluffy"},
		heightm: 1.55,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Fuwawa-Mega"],
		formeOrder: ["Fuwawa", "Fuwawa-Mega"],
	},
	fuwawamega: {
		num: 228,
		name: "Fuwawa-Mega",
		...
		types: ["Dark"],
		gender: "F",
		baseStats: {hp: 80, atk: 150, def: 145, spa: 100, spd: 165, spe: 60},
		abilities: {0: "Fluffy"},
		heightm: 1.55,
		weightkg: 55.5,
		color: "Blue",
		eggGroups: ["Human-Like", "Field"],
		requiredItem: "Fuwawite",
	},
	elizabeth: {
		num: 475,
		name: "Elizabeth",
		types: ["Fire", "Fighting"],
		gender: "F",
		baseStats: {hp: 105, atk: 125, def: 100, spa: 95, spd: 110, spe: 65},
		abilities: {0: "Justified", 1: "Punk Rock", H: "Sharpness"},
		heightm: 1.71,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
		otherFormes: ["Elizabeth-Mega"],
		formeOrder: ["Elizabeth", "Elizabeth-Mega"],
	},
	elizabethmega: {
		num: 475,
		name: "Elizabeth-Mega",
		baseSpecies: "Elizabeth",
		forme: "Mega",
		types: ["Fire", "Fighting"],
		gender: "F",
		baseStats: {hp: 105, atk: 150, def: 120, spa: 115, spd: 145, spe: 65},
		abilities: {0: "Sharpness"},
		heightm: 1.71,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
		requiredItem: "Elizalite",
	},
	gigi: {
		num: 529,
		name: "Gigi",
		types: ["Dark"],
		gender: "F",
		baseStats: {hp: 75, atk: 120, def: 75, spa: 115, spd: 75, spe: 140},
		abilities: {0: "Justified", 1: "Prankster", H: "Tough Claws"},
		heightm: 1.53,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like"],
		otherFormes: ["Gigi-Mega"],
		formeOrder: ["Gigi", "Gigi-Mega"],
	},
	gigimega: {
		num: 529,
		name: "Gigi-Mega",
		...
		types: ["Dark"],
		gender: "F",
		baseStats: {hp: 75, atk: 140, def: 95, spa: 135, spd: 85, spe: 170},
		abilities: {0: "Tough Claws"},
		heightm: 1.53,
		weightkg: 55.5,
		color: "Brown",
		eggGroups: ["Human-Like"],
		requiredItem: "Giginite",
	},
	cecilia: {
		num: 801,
		name: "Cecilia",
		...
		abilities: {0: "Justified", 1: "Sharpness", H: "Stamina"},
		heightm: 1.62,
		weightkg: 55.5,
		color: "Green",
		eggGroups: ["Human-Like", "Mineral"],
		otherFormes: ["Cecilia-Mega"],
		formeOrder: ["Cecilia", "Cecilia-Mega"],
	},
	ceciliamega: {
		num: 801,
		name: "Cecilia-Mega",
		...
		types: ["Steel", "Electric"],
		gender: "F",
		baseStats: {hp: 80, atk: 145, def: 175, spa: 130, spd: 110, spe: 60},
		abilities: {0: "Electric Surge"},
		heightm: 1.62,
		weightkg: 55.5,
		color: "Green",
		eggGroups: ["Human-Like", "Mineral"],
		requiredItem: "Cecilite",
	},
	raora: {
		num: 53,
		name: "Raora",
		...
		abilities: {0: "Justified", 1: "Keen Eye", H: "Trace"},
		heightm: 1.58,
		weightkg: 55.5,
		color: "Pink",
		eggGroups: ["Human-Like", "Field"],
		otherFormes: ["Raora-Mega"],
		formeOrder: ["Raora", "Raora-Mega"],
	},
	raoramega: {
		num: 53,
		name: "Raora-Mega",
		...
		types: ["Normal"],
		gender: "F",
		baseStats: {hp: 90, atk: 145, def: 110, spa: 125, spd: 95, spe: 135},
		abilities: {0: "Mind's Eye"},
		heightm: 1.58,
		weightkg: 55.5,
		color: "Pink",
